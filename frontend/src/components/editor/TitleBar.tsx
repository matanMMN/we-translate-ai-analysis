...
export class TitleBar {
    private tileBarDiv: HTMLElement | null;
    ...
    private close: Button | undefined;
    private open: Button | undefined;
    private documentEditor: DocumentEditor;
    private isRtl: boolean | undefined;
    private dialogComponent: Dialog | undefined

    constructor(element: HTMLElement | null, docEditor: DocumentEditor, isShareNeeded: boolean, isRtl?: boolean, dialogComponent?: Dialog) {
    ...
    private initializeTitleBar = (isShareNeeded: boolean): void => {
        ...
        const btnStyles: string = btnFloatStyle + 'background: transparent;box-shadow:none; font-family: inherit;border-color: transparent;'
    ...
    private addButton(iconClass: string, btnText: string, styles: string, id: string, tooltipText: string, isDropDown: boolean, items?: ItemModel[]): Button | DropDownButton {
        const button: HTMLButtonElement = createElement('button', {id: id, styles: styles}) as HTMLButtonElement;
    ...
    private onExportClick = (args: MenuEventArgs): void => {
        const value: string | undefined = args.item.id;
        switch (value) {
            case 'word':
                this.save('Docx');
                break;
    ...
    private save = (format: string): void => {
        // tslint:disable-next-line:max-line-length
        this.documentEditor.save(this.documentEditor.documentName === '' ? 'sample' : this.documentEditor.documentName as string, format as FormatType);
    }
}