export default function HugeIcon() {
    return (
        <svg width="24" height="24" viewBox="0 0 24 24" fill={"currentColor"} stroke="gray" xmlns="http://www.w3.org/2000/svg">
            <path
                ...
                stroke="#121417" strokeWidth="1.5" strokeLinecap="round"/>
        </svg>
