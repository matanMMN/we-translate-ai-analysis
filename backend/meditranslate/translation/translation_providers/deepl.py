...
from externals.services.translators.base import BaseTranslator, BaseTranslateException
from externals.services.translators.utils.annotations import Tuple, List
...
class DeeplTranslate(BaseTranslator):
    ...
    _supported_languages = {'AUTO','AR', 'BG', 'ZH', 'CS', 'DA', 'NL', 'EN', 'ET', 'FI', 'FR', 'DE', 'EL', 'HU', 'IT', 'JA', 'LV', 'LT', 'PL', 'PT', 'RO', 'RU', 'SK', 'SL', 'ES', 'SV', 'TR', 'ID', 'NB', 'KO', 'UK'}
