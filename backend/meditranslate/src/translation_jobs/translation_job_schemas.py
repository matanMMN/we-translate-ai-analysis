...
class PublicTranslationJobSchema(ObjectIdSchema,UserFullNamesModificationSchema,TranslationLanguagesSchema,ModificationTimestampSchema):
    ...
    is_translating: Optional[bool] = Field(None, title="is_translating", description="Is a translation request currently active?")
...
class TranslationJobUpdateSchema(BaseSchema):
    ...
    is_translating: Optional[bool] = Field(None, title="is_translating", description="")
