...
class FilePointerUpdateSchema(BaseSchema):
    original_file_name : Optional[OriginalFileNameStr]  = Field(..., title="original_file_name ", description="")
    file_name : Optional[FileNameStr] = Field(..., title="file_name ID", description="Unique identifier for the user")
    file_size : Optional[Union[float,int]] = Field(...,title="file_size", description="")
    file_path : Optional[FilePathStr] = Field(..., title="file_path", description="file_id")
    file_url : Optional[FileUrlStr] = Field(..., title="file_url", description="file_id")
    file_storage_provider: Optional[FileStorageProviderStr] = Field(..., title="file_url", description="file_id")
    file_format_type: Optional[FileFormatTypeStr] = Field(...,title="file_format_type", description="")
    file_metadata: Optional[dict] = Field(None,title="file_metadata", description="")
    ...
    processing_error: Optional[str] = None
    file_language: Optional[LanguageStr]  = Field(...,title="file_format_type", description="")
    upload_by: Optional[IdentifierStr] = Field(..., title="uploadeer user id",description=" user upload.")
