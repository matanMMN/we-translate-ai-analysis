...
export const AppName: string = "WeTranslateAI"
...
export const supportedSourceLanguages: readonly [string, ...string[]] = [languages.ENGLISH, languages.HEBREW] as readonly [string, ...string[]]
export const supportedTargetLanguages: readonly [string, ...string[]]= [languages.ENGLISH, languages.ARABIC, languages.HEBREW] as readonly [string, ...string[]]
